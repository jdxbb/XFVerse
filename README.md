...
**[访问 XFVerse 官网](https://xfverse.fun/)** · **[下载 XFVerse](https://xfverse.fun/download.html)** · [官网文档中心](https://xfverse.fun/docs/) · [安装与升级](https://xfverse.fun/docs/install.html) · [使用指南](https://xfverse.fun/docs/guide.html) · [帮助与排障](https://xfverse.fun/docs/help.html)
...
以下 1.0.0 候选产物已上传至[官网软件下载页](https://xfverse.fun/download.html)。下载页明确保持 Release Candidate 标识，不将当前候选包描述为 GA。
...
| [软件下载页](https://xfverse.fun/download.html) | 按 Windows x64 或 ARM64 架构下载候选安装包 |
