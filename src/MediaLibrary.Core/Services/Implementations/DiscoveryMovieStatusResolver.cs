        ...
        CancellationToken cancellationToken = default)
    {
        ...
        foreach (var group in movieRows.GroupBy(x => x.TmdbId))
        {
            ...
            result[movie.TmdbId] = new DiscoveryMovieStatus
            {
                ...
                LocalTypeTags = !string.IsNullOrWhiteSpace(movie.AiTagsText) ? movie.AiTagsText : movie.GenresText ?? string.Empty,
                LocalEmotionTags = movie.EmotionTagsText ?? string.Empty,
