...
## 6.2 Phase 6 收口与 Phase 7 计划入口

Phase 6 的页面覆盖矩阵、文档冲突检查、实现差距、Phase 7 拆分顺序与人工验收矩阵统一维护在：

- `PHASE_6_COVERAGE_MATRIX.md`

Phase 7 开始实施前，除本文件和对应页面规格外，还必须阅读该覆盖矩阵，以确认跨页面的导航、状态、字幕、安全操作和 Movie-only 边界不会在重构中回退。
